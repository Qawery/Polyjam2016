...
public class PatrolAI : MonoBehaviour 
{
	...
	public float standByTime;								//time of standby
	public float searchTime;
	public float defendChaseDistance;
	...
	private Health health;									//życie aktora
	...
	private TargetResolveEnum targetResolve;

	private float shrinkinkSpeed = 0.5f;
	private float standByTimeElapsed;
	...
	//czas oczekiwania po obsłudze celu
	//aktualny cel jako referencja na obiekt
	...
	* */
	...
	{
		transform.localScale = transform.localScale*shrinkinkSpeed;
